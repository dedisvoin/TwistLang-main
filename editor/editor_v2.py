...
class TwistLangLexer(QsciLexerCustom):
    ...
    def setup_styles(self):
        ...
        italic_font = get_safe_monospace_font(MONOSPACE_FONT_NAME, self.font_size)
        italic_font.setItalic(True)
        self.setFont(italic_font, self.STYLE_COMMENT)
        
        bold_font = get_safe_monospace_font(MONOSPACE_FONT_NAME, self.font_size)
        bold_font.setBold(True)
        self.setFont(bold_font, self.STYLE_KEYWORD)

        special_font = get_safe_monospace_font(MONOSPACE_FONT_NAME, self.font_size)
